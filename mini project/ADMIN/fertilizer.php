						...
						<?php
							...
							if ($count > 0) {
								...
								<tr>
									...
									<td>
										<a href="javascript:void(0);" class="deletebtn" data-column="fert_id" data-table="fertilizer" data-id="<?php echo $row["fert_id"]?>">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" class="form-control" id="fertName" placeholder="Fertilizer Name">
					</div>
				</div>
			...
			$('#addfertilizer').click(function(){
				...
				$.ajax({
					...
					if(data == 1){
						...
						window.location.href = 'fertilizer.php';
					}
				}).fail(function(error) {
					console.log(error);
				});
