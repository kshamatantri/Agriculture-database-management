					...
					<table class="table table-bordered">
						<thead>
							<tr>
								...
								<th>Name</th>
								<th>Disease</th>
								<th>Action</th> <!-- SELECT * from pesticide -->
							</tr>
						</thead>
						</tbody>
						<?php
							...
							if ($count > 0) {
								...
								<tr>
									...
									<td>
										<a href="javascript:void(0);" class="deletebtn" data-column="pest_id" data-table="pesticide" data-id="<?php echo $row["pest_id"]?>">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" class="form-control" id="pestname" placeholder="Pesticide Name">
